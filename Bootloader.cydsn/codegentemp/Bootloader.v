...
module top ;
	...
	wire [0:0] tmpOE__Bootload_EN_net;
	wire [0:0] tmpFB_0__Bootload_EN_net;
	wire [0:0] tmpIO_0__Bootload_EN_net;
	wire [0:0] tmpINTERRUPT_0__Bootload_EN_net;
	electrical [0:0] tmpSIOVREF__Bootload_EN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Bootload_EN
		 (.oe(tmpOE__Bootload_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Bootload_EN_net[0:0]}),
		  .io({tmpIO_0__Bootload_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__Bootload_EN_net),
		  .interrupt({tmpINTERRUPT_0__Bootload_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Bootload_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("35004652-45b3-4e0e-a25c-a603e236fda2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("08cea604-746d-44ad-a0df-057637e6fa88"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
